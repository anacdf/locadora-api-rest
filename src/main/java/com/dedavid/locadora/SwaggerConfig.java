...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo(
                "API Locadora",
                "Esta API é utilizada para gestão de uma locadora de filmes",
                "Versão 1.0",
                "https://github.com/anacdf",
                new Contact("Ana", "", ""),
    ...
    private ResponseMessage customMessage1() {
        ...
        map.put("location", new Header("location", "URI do novo recurso", new ModelRef("long")));
